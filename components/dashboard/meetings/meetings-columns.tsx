...
export const columns: ColumnDef<Meeting>[] = [
  {
    ...
    cell: ({ row }) => (
      <div className="font-medium cursor-pointer hover:text-primary transition-colors line-clamp-1">
        {row.getValue("title")}
      </div>
    ),
  },
  ...
  },
  {
    ...
    header: "Duration",
    cell: ({ row }) => <div className="text-muted-foreground">{row.getValue("duration_minutes")} min</div>,
  },
  {
    accessorKey: "status",
    header: "Status",
